...
export default { Expresion, OperacionBinaria, OperacionUnaria, Parentesis, Numero, DeclaracionVariable, ReferenciaVariable, Print, ExpresionStatement, Asignacion, Bloque, If, While }
