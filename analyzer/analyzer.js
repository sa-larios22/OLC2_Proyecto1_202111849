...
function peg$parse(input, options) {
  ...
  var peg$f12 = function() { return crearNodo('Numero', { valor: parseFloat(text()) }) };
  var peg$f13 = function(exp) { return crearNodo('Parentesis', { exp }) };
  var peg$f14 = function() { return crearNodo('ReferenciaVariable', { id: text() }) };
